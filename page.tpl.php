...
<?php if (!empty("SUAP2")) : ?>
<?php if (!$title) : ?>
<h1 class="art-headline" data-left="1.09%"><a href="<?php echo check_url($front_page); ?>" title = "<?php echo "SUAP2"; ?>"><?php echo "SUAP2";  ?></a></h1><?php else : ?>
<div class="art-headline">
  <a href="<?php echo check_url($front_page); ?>" title = "<?php echo "SUAP2"; ?>"><?php echo "SUAP2";  ?></a>
</div>
<?php endif; ?>
<?php endif; ?>

<h2 class="art-slogan" data-left="1.7%"><?php echo "Sportello unico attivit&agrave produttive" ?>
</h2>
...
<div class="art-content-layout">
    ...
    <div class="art-layout-cell layout-item-0" style="width: 50%">
        <p style="float: left; padding-left: 20px; text-align: left;"><a href="#">Home</a>|<a href="#">Contatti</a></p>
    ...
    <p class="art-page-footer">
        <span id="art-footnote-links">Powered by <a href="http://drupal.org/">Drupal</a> </span>
    </p>
  <?php
