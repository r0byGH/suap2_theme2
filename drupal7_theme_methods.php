...
$art_style = '';
$art_head = '';
function suap2_theme2_process_html(&$variables) {
...
function suap2_theme2_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function suap2_theme2_button($variables) {
 ...
 */
function suap2_theme2_preprocess_page(&$vars) {
  global $art_style, $art_head;
 ...
 * @ingroup themeable
 */
function suap2_theme2_menu_local_task($variables) {
 ...
 */
function suap2_theme2_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function suap2_theme2_node_preview($variables) {
  $node = $variables['node'];
...
*/
function suap2_theme2_form_alter(&$form, &$form_state, $form_id) {
...
function suap2_theme2_form_element_label($variables) {
...
function suap2_theme2_form_element($variables) {
  $element = &$variables['element'];
  // This is also used in the installer, pre-database setup.
  $t = get_t();
...
function suap2_theme2_pager($variables) {
  $tags = $variables['tags'];
  $element = $variables['element'];
